...
{
public: 
  typedef Graph<double, double, double> MyGraph;
  typedef Energy<double, double, double> MyEnergy;

	typedef double EnergyType;     // Type for the total energy the energy function.Change it in Graph.h 
	typedef double EnergyTermType;  // Type for the individual terms in the energy function.Change it in Graph.h 
	typedef MyEnergy::Var VarID;              
...
protected:
	...
	void (GCoptimization::*m_set_up_n_links_expansion)(SiteID,LabelID,MyEnergy*,VarID*,SiteID*);
	void (GCoptimization::*m_set_up_t_links_expansion)(SiteID,LabelID,MyEnergy*,VarID*,SiteID*);
	void (GCoptimization::*m_set_up_n_links_swap)(SiteID,LabelID,LabelID,MyEnergy*,VarID*,SiteID*);
	void (GCoptimization::*m_set_up_t_links_swap)(SiteID,LabelID,LabelID,MyEnergy*,VarID*,SiteID*);
	...
	void set_up_t_links_expansion(SiteID size, LabelID alpha_label,MyEnergy *e,VarID *variables, SiteID *activeSites );

	template <typename DataCostT> 
	void set_up_t_links_swap(SiteID size, LabelID alpha_label,LabelID beta_label,MyEnergy *e,VarID *variables, SiteID *activeSites );

	template <typename SmoothCostT> 
	void set_up_n_links_expansion(SiteID size, LabelID alpha_label,MyEnergy *e,VarID *variables,SiteID *activeSites );

	template <typename SmoothCostT> 
	void set_up_n_links_swap(SiteID size, LabelID alpha_label,LabelID beta_label,MyEnergy *e,VarID *variables,SiteID *activeSites );
...
private:
	...
	void set_up_expansion_energy(SiteID size, LabelID alpha_label,MyEnergy *e,VarID *variables, SiteID *activeSites );
...
template <typename DataCostT>
void GCoptimization::set_up_t_links_expansion(SiteID size, LabelID alpha_label,MyEnergy *e,
...
template <typename SmoothCostT>
void GCoptimization::set_up_n_links_expansion(SiteID size, LabelID alpha_label,MyEnergy *e,
     										  VarID *variables,SiteID *activeSites )
{
...
void GCoptimization::set_up_t_links_swap(SiteID size, LabelID alpha_label, LabelID beta_label,
										 MyEnergy *e,VarID *variables,SiteID *activeSites )
{
	DataCostT* dc = (DataCostT*)m_datacostFn;
