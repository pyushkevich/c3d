...
#### -label-voting: use LabelVoting among multilabel images on the stack

Syntax: `-label-voting <label of undecided voxels> [number of stack images to use]`

This command takes a number of multilabel images on the stack and do majority voting, when the voting is a tie the label is set to the <label of undecided voxels> value.
